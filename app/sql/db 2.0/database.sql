...
-- -----------------------------------------------------
-- Table `somethi1_tingfinderdb`.`shippinginformation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `somethi1_tingfinderdb`.`shippinginformation` (
  ...
  PRIMARY KEY (`idshippinginformation`, `zipcodes_idzipcodes`),
...
CREATE TABLE IF NOT EXISTS `somethi1_tingfinderdb`.`orders` (
  ...
  `shippinginformation_idshippinginformation` INT NOT NULL,
  `shippinginformation_zipcodes_idzipcodes` INT NOT NULL,
  PRIMARY KEY (`idorders`, `shippinginformation_idshippinginformation`, `shippinginformation_zipcodes_idzipcodes`),
  INDEX `fk_orders_shippinginformation1_idx` (`shippinginformation_idshippinginformation` ASC, `shippinginformation_zipcodes_idzipcodes` ASC),
  CONSTRAINT `fk_orders_shippinginformation1`
    FOREIGN KEY (`shippinginformation_idshippinginformation` , `shippinginformation_zipcodes_idzipcodes`)
    REFERENCES `somethi1_tingfinderdb`.`shippinginformation` (`idshippinginformation` , `zipcodes_idzipcodes`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `somethi1_tingfinderdb`.`products` (
  ...
  PRIMARY KEY (`idproducts`, `productcategory_idproductcategory`),
...
CREATE TABLE IF NOT EXISTS `somethi1_tingfinderdb`.`productimages` (
  ...
  PRIMARY KEY (`idproductimages`, `products_idproducts`),
